@extends('layouts.user.index') @section('title', __('messages.matches')) @section('custom-styles')
            ...
            <div class="d-flex flex-row">
                <div class="w-100 flex-lg-row-fluid mx-lg-13">
                    ...
                    <div class="mb-10" id="kt_social_feeds_posts">
                        @include('components.pagination.default', ['data' => $datas['announcements']]) @foreach ($datas['announcements']['data'] as $key => $announcement)
