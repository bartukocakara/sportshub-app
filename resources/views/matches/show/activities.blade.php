...
<script>
   ...
   window.translations = {
        ...
        'match.created': ':user bir takım oluşturdu',
        'match.joined': ':user bir takıma katıldı',
        'match.invited': ':user bir takıma davet edildi',
        'match.updated': ':user bir takımı güncelledi',
        'just_now': 'Şimdi',
