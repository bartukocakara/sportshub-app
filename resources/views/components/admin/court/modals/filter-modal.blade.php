<div class="modal fade" id="kt_filter_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <form action="{{ route('admin.courts.index') }}" method="GET" class="form">
                <div class="modal-header">
                    <h2 class="fw-bold">{{ __('messages.filter_matches') }}</h2>
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="row mb-5">
                        <div class="col-12 mb-5">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="{{ __('messages.search_match_title') }}">
                        </div>
                        <div class="col-12 mb-5">
