                ...
                <div class="d-flex flex-column flex-lg-row">
                            ...
                            <div class="card-body">
                                ...
                                <div id="kt_user_view_details" class="collapse show">
                                    <div class="pb-5 fs-6">
                                        ...
                                        <div class="text-gray-600">22 Sep 2025, 10:10 pm</div>
                                        <!--begin::Details item-->
                                    </div>
                                </div>
                                <!--end::Details content-->
                    ...
                    <div class="flex-lg-row-fluid ms-lg-15">
                        ...
                        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8" role="tablist">
                            ...
                            <!--begin:::Tab item-->
                            <li class="nav-item" role="presentation">
                                <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_user_view_overview_security" data-kt-initialized="1" aria-selected="false" tabindex="-1" role="tab">
                                    Security
                                </a>
                            </li>
                            <!--end:::Tab item-->
                                            ...
                                            <div id="kt_schedule_day_3" class="tab-pane fade show" role="tabpanel">
                                                ...
                                                <div class="d-flex flex-stack position-relative mt-6">
                                                    ...
                                                    <div class="fw-semibold ms-5">
                                                        ...
                                                        <!--begin::User-->
                                                        <div class="fs-7 text-muted">Lead by <a href="#">Yannis Gloverson</a></div>
                                                        <!--end::User-->
                                                    </div>
                                                    <!--end::Info-->
                                                ...
                                                <form class="form px-7 py-5 fv-plugins-bootstrap5 fv-plugins-framework" data-kt-menu-id="kt-users-tasks-form">
                                                    ...
                                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                                        ...
                                                        <select
                                                            ...
                                                            data-select2-id="select2-data-7-gbqh"
                                                            tabindex="-1"
                                                            aria-hidden="true"
                                                            data-kt-initialized="1"
                                                        >
                                                            <option data-select2-id="select2-data-9-1fty"></option>
                                                            <option value="1">Approved</option>
                                                            <option value="2">Pending</option>
                                                            <option value="3">In Process</option>
                                                            <option value="4">Rejected</option>
                                                        </select>
                                                        <span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-8-9sut" style="width: 100%;">
                                                            <span class="selection">
                                                                <span
                                                                    ...
                                                                    tabindex="0"
                                                                    aria-disabled="false"
                                                                    aria-labelledby="select2-task_status-u3-container"
                                                                    aria-controls="select2-task_status-u3-container"
                                                                >
                                                                    <span class="select2-selection__rendered" id="select2-task_status-u3-container" role="textbox" aria-readonly="true" title="Select option">
                                                ...
                                                <form class="form px-7 py-5 fv-plugins-bootstrap5 fv-plugins-framework" data-kt-menu-id="kt-users-tasks-form">
                                                    ...
                                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                                        ...
                                                        <select
                                                            ...
                                                            data-allow-clear="true"
                                                            data-hide-search="true"
                                                            data-select2-id="select2-data-10-uqr0"
                                                            tabindex="-1"
                                                            aria-hidden="true"
                                                            data-kt-initialized="1"
                                                        >
                                                            <option data-select2-id="select2-data-12-2w0u"></option>
                                                            <option value="1">Approved</option>
                                                            <option value="2">Pending</option>
                                                            <option value="3">In Process</option>
                                                            <option value="4">Rejected</option>
                                                        </select>
                                                        <span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-11-u1tp" style="width: 100%;">
                                                            <span class="selection">
                                                                <span
                                                                    class="select2-selection select2-selection--single form-select form-select-solid"
                                                                    role="combobox"
                                                                    ...
                                                                    tabindex="0"
                                                                    aria-disabled="false"
                                                                    aria-labelledby="select2-task_status-y1-container"
                                                                    aria-controls="select2-task_status-y1-container"
                                                                >
                                                                    <span class="select2-selection__rendered" id="select2-task_status-y1-container" role="textbox" aria-readonly="true" title="Select option">
                                                                        <span class="select2-selection__placeholder">Select option</span>
                                                                    </span>
                                                                    <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                                                </span>
                                                ...
                                                <form class="form px-7 py-5 fv-plugins-bootstrap5 fv-plugins-framework" data-kt-menu-id="kt-users-tasks-form">
                                                    ...
                                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                                        ...
                                                        <select
                                                            ...
                                                            data-allow-clear="true"
                                                            data-hide-search="true"
                                                            data-select2-id="select2-data-13-ziqb"
                                                            tabindex="-1"
                                                            aria-hidden="true"
                                                            data-kt-initialized="1"
                                                        >
                                                            <option data-select2-id="select2-data-15-cevk"></option>
                                                            <option value="1">Approved</option>
                                                            <option value="2">Pending</option>
                                                            <option value="3">In Process</option>
                                                            <option value="4">Rejected</option>
                                                        </select>
                                                        <span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-14-b4dr" style="width: 100%;">
                                                            <span class="selection">
                                                                <span
                                                                    class="select2-selection select2-selection--single form-select form-select-solid"
                                                                    role="combobox"
                                                                    ...
                                                                    tabindex="0"
                                                                    aria-disabled="false"
                                                                    aria-labelledby="select2-task_status-t2-container"
                                                                    aria-controls="select2-task_status-t2-container"
                                                                >
                                                                    <span class="select2-selection__rendered" id="select2-task_status-t2-container" role="textbox" aria-readonly="true" title="Select option">
                                                                        <span class="select2-selection__placeholder">Select option</span>
                                                                    </span>
                                                                    <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                                                </span>
                                                ...
                                                <form class="form px-7 py-5 fv-plugins-bootstrap5 fv-plugins-framework" data-kt-menu-id="kt-users-tasks-form">
                                                    ...
                                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                                        ...
                                                        <select
                                                            ...
                                                            data-allow-clear="true"
                                                            data-hide-search="true"
                                                            data-select2-id="select2-data-16-ea5b"
                                                            tabindex="-1"
                                                            aria-hidden="true"
                                                            data-kt-initialized="1"
                                                        >
                                                            <option data-select2-id="select2-data-18-o3a9"></option>
                                                            <option value="1">Approved</option>
                                                            <option value="2">Pending</option>
                                                            <option value="3">In Process</option>
                                                            <option value="4">Rejected</option>
                                                        </select>
                                                        <span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-17-awl2" style="width: 100%;">
                                                            <span class="selection">
                                                                <span
                                                                    class="select2-selection select2-selection--single form-select form-select-solid"
                                                                    role="combobox"
                                                                    ...
                                                                    tabindex="0"
                                                                    aria-disabled="false"
                                                                    aria-labelledby="select2-task_status-3a-container"
                                                                    aria-controls="select2-task_status-3a-container"
                                                                >
                                                                    <span class="select2-selection__rendered" id="select2-task_status-3a-container" role="textbox" aria-readonly="true" title="Select option">
                                                                        <span class="select2-selection__placeholder">Select option</span>
                                                                    </span>
                                                                    <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                                                </span>
                                                ...
                                                <form class="form px-7 py-5 fv-plugins-bootstrap5 fv-plugins-framework" data-kt-menu-id="kt-users-tasks-form">
                                                    ...
                                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                                        ...
                                                        <select
                                                            ...
                                                            data-allow-clear="true"
                                                            data-hide-search="true"
                                                            data-select2-id="select2-data-19-27wu"
                                                            tabindex="-1"
                                                            aria-hidden="true"
                                                            data-kt-initialized="1"
                                                        >
                                                            <option data-select2-id="select2-data-21-v240"></option>
                                                            <option value="1">Approved</option>
                                                            <option value="2">Pending</option>
                                                            <option value="3">In Process</option>
                                                            <option value="4">Rejected</option>
                                                        </select>
                                                        <span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-20-qqow" style="width: 100%;">
                                                            <span class="selection">
                                                                <span
                                                                    class="select2-selection select2-selection--single form-select form-select-solid"
                                                                    role="combobox"
                                                                    ...
                                                                    tabindex="0"
                                                                    aria-disabled="false"
                                                                    aria-labelledby="select2-task_status-pn-container"
                                                                    aria-controls="select2-task_status-pn-container"
                                                                >
                                                                    <span class="select2-selection__rendered" id="select2-task_status-pn-container" role="textbox" aria-readonly="true" title="Select option">
                                                                        <span class="select2-selection__placeholder">Select option</span>
                                                                    </span>
                                                                    <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                                                </span>
                                            ...
                                            <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            POST /v1/invoices/in_3435_4010/payment
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            POST /v1/customer/c_6872a330ea194/not_found
                                                        </td>
                                                        <td class="pe-0 text-end min-w-200px">
                                                            20 Jun 2025, 5:20 pm
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            POST /v1/invoices/in_1019_5140/payment
                                                        </td>
                                                        <td class="pe-0 text-end min-w-200px">
                                                            19 Aug 2025, 6:05 pm
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            POST /v1/invoice/in_4284_8328/invalid
                                                        </td>
                                                        <td class="pe-0 text-end min-w-200px">
                                                            10 Mar 2025, 5:30 pm
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            POST /v1/customer/c_6872a330ea192/not_found
                                                        </td>
                                                        <td class="pe-0 text-end min-w-200px">
                                    ...
                                    <div class="card-body py-0">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="min-w-400px">
                                                        Invoice <a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#DER-45645</a> status has changed from <span class="badge badge-light-info me-1">In Progress</span> to
                                                ...
                                                <tr>
                                                    <td class="min-w-400px">
                                                        Invoice <a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#SEP-45656</a> status has changed from <span class="badge badge-light-warning me-1">Pending</span> to
                                                ...
                                                <tr>
                                                    <td class="min-w-400px">
                                                        Invoice <a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#KIO-45656</a> status has changed from <span class="badge badge-light-succees me-1">In Transit</span> to
                                        ...
                                        <div id="kt_modal_update_user_user_info" class="collapse show">
                                            ...
                                            <div class="fv-row mb-15">
                                                ...
                                                <select
                                                    ...
                                                    data-select2-id="select2-data-22-9s4q"
                                                    tabindex="-1"
                                                    aria-hidden="true"
                                                    data-kt-initialized="1"
                                                >
                                                    <option data-select2-id="select2-data-24-0opw"></option>
                                                ...
                                                <span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-23-ur0d" style="width: 100%;">
                                                    <span class="selection">
                                                        <span
                                                            class="select2-selection select2-selection--single form-select form-select-solid"
                                                            role="combobox"
                                                            ...
                                                            tabindex="0"
                                                            aria-disabled="false"
                                                            aria-labelledby="select2-language-k3-container"
                                                            aria-controls="select2-language-k3-container"
                                                        >
                                                            <span class="select2-selection__rendered" id="select2-language-k3-container" role="textbox" aria-readonly="true" title="Select a Language...">
                                        ...
                                        <div id="kt_modal_update_user_address" class="collapse show">
                                            ...
                                            <div class="d-flex flex-column mb-7 fv-row">
                                                ...
                                                <select
                                                    ...
                                                    class="form-select form-select-solid select2-hidden-accessible"
                                                    data-dropdown-parent="#kt_modal_update_details"
                                                    data-select2-id="select2-data-25-9oug"
                                                    tabindex="-1"
                                                    aria-hidden="true"
                                                    data-kt-initialized="1"
                                                >
                                                    <option value="" data-select2-id="select2-data-27-y679">Select a Country...</option>
                                                ...
                                                <span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-26-jl75" style="width: 100%;">
                                                    <span class="selection">
                                                        <span
                                                            class="select2-selection select2-selection--single form-select form-select-solid"
                                                            role="combobox"
                                                            ...
                                                            tabindex="0"
                                                            aria-disabled="false"
                                                            aria-labelledby="select2-country-5r-container"
                                                            aria-controls="select2-country-5r-container"
                                                        >
                                                            <span class="select2-selection__rendered" id="select2-country-5r-container" role="textbox" aria-readonly="true" title="Select a Country...">
                                ...
                                <form id="kt_modal_add_schedule_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                                    ...
                                    <div class="fv-row mb-7 fv-plugins-icon-container">
                                        ...
                                        <tags class="tagify form-control form-control-solid" tabindex="-1">
                                            <tag title="smith@kpmg.com" contenteditable="false" tabindex="-1" class="tagify__tag tagify--noAnim" value="smith@kpmg.com">
                                                <x title="" tabindex="-1" class="tagify__tag__removeBtn" role="button" aria-label="remove tag"></x>
                                                <div><span autocapitalize="false" autocorrect="off" spellcheck="false" class="tagify__tag-text">smith@kpmg.com</span></div>
                                            </tag>
                                            <tag title="melody@altbox.com" contenteditable="false" tabindex="-1" class="tagify__tag tagify--noAnim" value="melody@altbox.com">
                                                <x title="" tabindex="-1" class="tagify__tag__removeBtn" role="button" aria-label="remove tag"></x>
                                                <div><span autocapitalize="false" autocorrect="off" spellcheck="false" class="tagify__tag-text">melody@altbox.com</span></div>
                                            </tag>
                                            <span
                                                contenteditable=""
                                                tabindex="0"
                                        ...
                                        <input id="kt_modal_add_schedule_tagify" type="text" class="form-control form-control-solid" name="event_invitees" value="smith@kpmg.com, melody@altbox.com" tabindex="-1" />
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                <div class="fw-bold d-flex flex-column justify-content-center mb-5">
                                    <!--begin::Label-->
                                    <div class="text-center mb-5" data-kt-add-auth-action="qr-code-label">Download the <a href="#">Authenticator app</a>, add a new account, then scan this barcode to set up your account.</div>
                                    <div class="text-center mb-5 d-none" data-kt-add-auth-action="text-code-label">Download the <a href="#">Authenticator app</a>, add a new account, then enter this code to set up your account.</div>
                                    <!--end::Label-->
