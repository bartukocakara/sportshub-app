...
var KTAppSidebar = function() {
    ...
    return {
        init: function() {
            var r, o;
            e = document.querySelector("#kt_app_sidebar_main_wrappers"),
            t = document.querySelector("#kt_app_sidebar_menu_projects_collapse"),
            n = document.querySelector("#kt_app_sidebar_header"),
            (i = document.querySelector("#kt_app_sidebar_toggle")) && null !== (r = KTToggle.getInstance(i)) && r.on("kt.toggle.changed", (function() {
                var e = new Date(Date.now() + 2592e6);
                KTCookie.set("sidebar_minimize_state", r.isEnabled() ? "on" : "off", {
                    expires: e
                })
            }
            )),
            e && (o = e.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(o, e) && e.scroll({
                top: KTUtil.getRelativeTopPosition(o, e),
                behavior: "smooth"
            }),
            t && t.addEventListener("shown.bs.collapse", (t => {
                const n = parseInt(KTUtil.css(e, "height"));
                e.scroll({
                    top: n,
                    behavior: "smooth"
                })
            ...
            n && function() {
                const e = n.querySelector('[data-kt-element="selected"]')
                  , t = n.querySelector('[data-kt-menu="true"]');
                KTUtil.on(n, '[data-kt-element="project"]', "click", (function(n) {
                    const i = this.querySelector('[data-kt-element="logo"]')
                      , r = this.querySelector('[data-kt-element="title"]')
                      , o = this.querySelector('[data-kt-element="desc"]')
                      , a = t.querySelector(".menu-link.active");
                    e.querySelector('[data-kt-element="logo"]').setAttribute("src", i.getAttribute("src")),
                    e.querySelector('[data-kt-element="title"]').innerText = r.innerText,
                    e.querySelector('[data-kt-element="desc"]').innerText = o.innerText,
